//
//  DYCollectionViewControllerDelegate.h
//  
//
...
@interface DYCollectionViewControllerDelegate : NSObject<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
